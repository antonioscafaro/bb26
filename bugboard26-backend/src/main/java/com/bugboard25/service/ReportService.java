...
public class ReportService {
    ...
    public ReportMensileDTO generaReport(int idProgetto, int mese, int anno, String emailUtente) {
        ...
        FilteredReportData filtered = applyUserFilter(data, emailUtente, progetto, idProgetto, dataInizio, dataFine);
    ...
    private ReportDataHolder fetchIssueData(Progetti progetto, Date dataInizio, Date dataFine) {
        ...
        if (progetto != null) {
            return new ReportDataHolder(
                    ...
                    issueRepository.countOpenDuringPeriodByProject(progetto, dataInizio, dataFine)
            );
        }
        return new ReportDataHolder(
                ...
                issueRepository.countOpenDuringPeriod(dataInizio, dataFine)
        );
    }

    private FilteredReportData applyUserFilter(ReportDataHolder data, String emailUtente,
                                                Progetti progetto, int idProgetto, Date dataInizio, Date dataFine) {
        ...
        if (utenteSelezionato != null) {
            ...
            long openCount = (progetto != null)
                    ? issueRepository.countOpenDuringPeriodByProjectAndUser(progetto, u, dataInizio, dataFine)
                    : issueRepository.countOpenDuringPeriodByUser(u, dataInizio, dataFine);
