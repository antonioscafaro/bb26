...
class IssueServiceTest {
    ...
    void testUpdateIssueById_AdminSetsFields(){
        ...
        verify(etichetteService, never()).findOrCreate(any(EtichettaCreateRequestDTO.class));
    ...
    void testUpdateIssueById_AdminSetsLabels(){
        ...
        when(etichetteService.findOrCreate(any(EtichettaCreateRequestDTO.class)))
                .thenReturn(label1)
                .thenReturn(label2);
        ...
        assertNotNull(result);
        assertEquals("admin@test.com", result.getAssegnatario().getEmail());
        verify(etichetteService, times(2)).findOrCreate(any(EtichettaCreateRequestDTO.class));
    ...
    void testCreaIssue_NoFileOneLabel() throws IOException {
        ...
        assertNotNull(result);
        verify(issueRepository, times(1)).save(any(Issue.class));
        verify(etichetteService, times(1)).findOrCreate(any(EtichettaCreateRequestDTO.class));
