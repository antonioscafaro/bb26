\subsection{Unit test automatici}
Abbiamo scelto di effettuare test di unità automatici sui metodi \texttt{updateIssueById} e \texttt{creaIssue}.

Codice della classe di test:
\begin{lstlisting}[literate={<>}{{\textless\textgreater}}2 {->}{{->}}2 {è}{{\`e}}1 {ò}{{\`o}}1 {ù}{{\`u}}1 {ì}{{\`i}}1 {ú}{{\'u}}1]
