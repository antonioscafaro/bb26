...
\item Per Stato usa ordine: ToDo, In Lavorazione, Risolta, Chiusa
...
\paragraph{Output}
Lista filtrata con solo le issue assegnate all'utente, organizzazione per stato (ToDo, In Lavorazione, Risolta, Chiusa), possibilità di cambiare stato direttamente.
...
\begin{reqbox}[title=REQ-FUN-20: Visualizza Notifiche]
...
\begin{reqbox}[title=REQ-FUN-21: Prendi Visione Notifica]
...
\begin{reqbox}[title=REQ-FUN-22: Creazione Utenze (solo Admin)]
...
\begin{reqbox}[title=REQ-FUN-23: Modifica Utenze (solo Admin)]
...
\begin{reqbox}[title=REQ-FUN-24: Rimozione Utenze (solo Admin)]
...
\begin{reqbox}[title=REQ-FUN-25: Assegna Issue (solo Admin)]
...
\begin{reqbox}[title=REQ-FUN-26: Archivia Issue (solo Admin)]
...
\begin{reqbox}[title=REQ-FUN-27: Visualizza Report Mensile (solo Admin)]
