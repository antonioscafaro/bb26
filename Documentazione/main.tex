...
\lstset{
    ...
    stepnumber=1,
    frame=single, % Mette un riquadro attorno al codice
    breaklines=true
}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textcolor{bb-outline}{\bfseries \productname} - Documentazione}
...
\input{sections/00-frontespizio}
...
% SEZIONE 2: GLOSSARIO
% ---------------------------------------------------------------------
\input{sections/02-glossario}

\newpage
% ---------------------------------------------------------------------
% SEZIONE 3: CASI D'USO
% ---------------------------------------------------------------------
\input{sections/03-casi-uso}

% ---------------------------------------------------------------------
% SEZIONE 4: CARATTERIZZAZIONE UTENTI
% ---------------------------------------------------------------------
\input{sections/04-caratterizzazione-utenti}
...
\input{sections/05-requisiti-sistema}
\input{sections/06-requisiti-funzionali}
\input{sections/07-requisiti-non-funzionali}
%%\input{sections/07a-vincoli-progettazione}

\newpage
% ---------------------------------------------------------------------
% SEZIONE 6: DESCRIZIONE DETTAGLIATA CASI D'USO (COCKBURN)
% ---------------------------------------------------------------------
\input{sections/08-cockburn}

\newpage
% ---------------------------------------------------------------------
% SEZIONE 7: MOCKUP
% ---------------------------------------------------------------------
\input{sections/09-mockup}

\newpage
\section{Design del sistema}
\input{sections/10-system-design.tex}

\section{Software Design}
\input{sections/11-database.tex}

\newpage
\input{sections/12-design-classes.tex}

\newpage
\input{sections/13-versioning.tex}

\newpage
\input{sections/14-report-qualità.tex}

\newpage
\section{Testing}
\input{sections/15-testing-plan.tex}

\newpage
\input{sections/16-automatic-testing.tex}

\newpage
\input{sections/17-documentazione-testing.tex}
